...
```{r}
prop.table(table(sex,ans,place)) # Frecuencia relativa global
prop.table(table(sex,ans,place),margin = 3)# Frecuencia relativa Marginal por lugal
prop.table(table(sex,ans,place), margin = c(1,3)) #Frecuencia relativa maarginal por sexo y pais
